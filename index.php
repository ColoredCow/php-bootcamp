...
<!--Past Events -->
            <h1 class="mt-4 display-4"> Past Events </h1>
                <div class="row mb-5" id="pastEvent" >
                    <div class="col-sm-4" v-for="pastEvent in pastEvents">
                        <div class="card height-10rem width-10rem mb-5">
                            <img class="card-img-top" :src="pastEvent.img" alt="Card image cap" height="250px;">
                        <div class="card-body">
                            <h6><span><i class="fas fa-calendar-alt"></i>&nbsp;{{pastEvent.date}}</span></h6>
                            <h6><span><i class="fas fa-map-marker-alt"></i>&nbsp;{{pastEvent.location}}</span></h6>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contrainer-fluid">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" id="myCarousel">
                    <div v-for="image, key in images" class="carousel-item" :class="key== 0 ? 'active':''">
                        <img class="d-block w-100" v-bind:src="image.img" alt="slides" height="350px;">
                    </div>
                </div>
    ...
    <div class="modal fade" id="RSVPModal" tabindex="-1" role="dialog" aria-labelledby="RSVPModel" aria-hidden="true">
        <div class="modal-dialog" role="document"  id="rsvpModal">
                ...
                <div class="form-row align-items-center">
                    <div class="col">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" class="form-control" v-model="modalData.name" name="name" placeholder="Name">
                        </div>
                    </div>
                </div>
                <div class="form-row align-items-center">
                    <div class="col">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" v-model="modalData.phone" name="phone" placeholder="Phone">
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" v-on:click="displayData()">Yes, I want to attend</button>
        </div>
    </div>
    </div>
    </div>
    ...
    <script>
        ...
        var app = new Vue({
                ...
                methods: {
                    displayData(){
                           let uri = 'dbconnect.php';
                           axios.post(uri, { name: this.modalData.name, phone: this.modalData.phone,
