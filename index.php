...
<body>
    ...
    <div class="container" v-show="hasPastEvents">
        <div class="row justify-content-md-center">
            <div class="col-10">
                <hr>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <form>
                <div class="form-row align-items-center">
                    <div class="col">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" v-model="RSVPName" class="form-control" id="inlineFormInputGroup" placeholder="Name">
                        </div>
                    </div>
                </div>
                <div class="form-row align-items-center">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="text" v-model="RSVPPhone"  class="form-control" id="inlineFormInputGroup" placeholder="Phone">
                </div>
                </div>
                </div>
            </form>    
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" v-on:click="rsvp">Yes, I want to attend</button>
        </div>
        </div>
    </div>
    </div>
    ...
    var app = new Vue({
        ...
        methods: {
            rsvp() {
                ...
                console.log(this.RSVPName);
                console.log(this.RSVPPhone);
    // submit data
                this.RSVPName = '';
                this.RSVPPhone = '';
            }
